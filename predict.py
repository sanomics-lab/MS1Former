...
from models import cnn_module, CNN_RNN, dilated_cnn_module, cnn2d_transformer_module, transformer_module
# import h5py
...
class Predict(object):
    ...
    def pred(self,test_ls):
        ...
        test_loader = DataLoader(val_set,batch_size=8,shuffle=True,num_workers = 8,prefetch_factor=2, collate_fn=collate_fn)
        ...
        #import IPython
        #IPython.embed()
        np.save("/mnt/sano1/home/snn/workplace/spectra00/spectra_classfification/DeepDDA-disease/data/vectors/fold3_4_hidden_vector.npy", Vectors)
        print(accuracy)
        ...
        print(infos)
        infos.to_excel("/mnt/sano1/home/snn/workplace/spectra00/spectra_classfification/DeepDDA-disease/data/vectors/fold3_4_val.xlsx")
